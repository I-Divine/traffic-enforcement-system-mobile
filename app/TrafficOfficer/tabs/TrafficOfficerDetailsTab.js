...
export default function TrafficOfficerDetailsTab({ profile }) {
  const {
    firstName,
    lastName,
    email,
  ...
  const badgeNumber = officerDetails?.badgeNumber || "N/A";
  const assignmentArea = officerDetails?.assignmentArea || "N/A";
  const department = officerDetails?.department || "N/A";
  const rank = officerDetails?.rank || "N/A";
    ...
    <View style={styles.shellCard}>
      <View style={styles.cardHeader}>
        <View>
          ...
          <Text style={styles.docType}>Officer ID Card</Text>
        </View>
        <View style={styles.validTag}>
          <Text style={styles.validTagText}>ACTIVE</Text>
        </View>
      </View>

      <View style={styles.watermarkWrap}>
        <Text style={styles.watermark}>TO</Text>
      </View>
      ...
      <View style={styles.mainSection}>
        ...
        <View style={styles.identityBlock}>
          ...
          <Text style={styles.idNumber}>{badgeNumber}</Text>
        </View>
      </View>
      ...
      <View style={styles.gridRow}>
        ...
        <View style={styles.gridItem}>
          ...
          <Text style={styles.fieldValue}>{formatDate(lastLogin)}</Text>
        </View>
      </View>

      <View style={styles.gridRow}>
        <View style={styles.gridItemFull}>
          <Text style={styles.fieldLabel}>Assignment Area</Text>
          <Text style={styles.fieldValue}>{assignmentArea}</Text>
        </View>
      </View>
      ...
      <View style={styles.footerStrip}>
        <Text style={styles.footerText}>Officer Record</Text>
